...
import com.woorea.openstack.examples.OpenstackConfiguration;
...
public class KeystoneCreateTenant {
	...
	public static void main(String[] args) {
		Keystone keystone = new Keystone(OpenstackConfiguration.KEYSTONE_AUTH_URL);
		//access with unscoped token
		Access access = keystone.tokens().authenticate(
				new UsernamePassword(OpenstackConfiguration.ADMIN_KEYSTONE_USERNAME, OpenstackConfiguration.ADMIN_KEYSTONE_PASSWORD))
				.execute();
