...
public class RoutersResource {
  ...
  public Delete delete(String routeId){
    return new Delete(routeId);
  }

  public Show show(String routeId){
    return new Show(routeId);
  }
...
//      return target.request(MediaType.APPLICATION_JSON).get(Ports.class);
  ...
  public class Create extends OpenStackRequest<Router> {
    ...
    public Create(RouterForCreate port){
        super(CLIENT, HttpMethod.POST, "routers", Entity.json(port), Router.class);
    }
  }
